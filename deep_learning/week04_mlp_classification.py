...
figs = []
output_dir = os.path.join(current_dir,"..","result", "week04_line_charts")
os.makedirs(output_dir, exist_ok=True)
data = FashionMNISTData()

lr, batch_size,num_hiddens_1,num_hiddens_2,dropout_1,dropout_2=0.1,256,256,256,0.5,0.5
...
fig = trainer.train()
path = os.path.join(output_dir, f"num_hiddens_1={num_hiddens_1}_num_hiddens_2={num_hiddens_2}_dropout_1={dropout_1}_dropout_2={dropout_2}.jpg")
plt.savefig(path, format='jpg', bbox_inches='tight')
# figs.append(fig)
# plt.show() 

lr, batch_size,num_hiddens_1,num_hiddens_2,dropout_1,dropout_2=0.1,256,256,256,0.25,0.25
model = MLPRegression(num_outputs=10, lr=lr,batch_size=batch_size,
                      num_hiddens_1=num_hiddens_1,num_hiddens_2=num_hiddens_2,
                      dropout_1=dropout_1,dropout_2=dropout_2)
trainer = Trainer(model=model, date=data,max_epoch=10)
...
lr, batch_size,num_hiddens_1,num_hiddens_2,dropout_1,dropout_2=0.1,256,128,128,0.5,0.5
model = MLPRegression(num_outputs=10, lr=lr,batch_size=batch_size,
                      num_hiddens_1=num_hiddens_1,num_hiddens_2=num_hiddens_2,
                      dropout_1=dropout_1,dropout_2=dropout_2)
trainer = Trainer(model=model, date=data,max_epoch=10)
...
lr, batch_size,num_hiddens_1,num_hiddens_2,dropout_1,dropout_2=0.1,256,512,512,0.5,0.5
model = MLPRegression(num_outputs=10, lr=lr,batch_size=batch_size,
                      num_hiddens_1=num_hiddens_1,num_hiddens_2=num_hiddens_2,
                      dropout_1=dropout_1,dropout_2=dropout_2)
trainer = Trainer(model=model, date=data,max_epoch=10)
...
lr, batch_size,num_hiddens_1,num_hiddens_2,dropout_1,dropout_2=0.1,256,256,256,0.75,0.75
model = MLPRegression(num_outputs=10, lr=lr,batch_size=batch_size,
                      num_hiddens_1=num_hiddens_1,num_hiddens_2=num_hiddens_2,
                      dropout_1=dropout_1,dropout_2=dropout_2)
trainer = Trainer(model=model, date=data,max_epoch=10)
